...
namespace StudentTracking.Web.Controllers
{
    public class HolidaysController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,HolidayDate,HolidayDay")] Holiday holiday)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,HolidayDate,HolidayDay")] Holiday holiday)
        {
            if (ModelState.IsValid)
            {
